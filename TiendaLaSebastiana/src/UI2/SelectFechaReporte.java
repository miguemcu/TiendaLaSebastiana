 ...
 * @author DELL
 */
public class SelectFechaReporte extends javax.swing.JInternalFrame {
    ...
    private Main main;
    /**
     * Creates new form SelectFechaReporte
     */
    ...
    private void btnConsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConsultarActionPerformed
        ...
        try {
            ...
            try {
                ...
                Logger.getLogger(SelectFechaReporte.class.getName()).log(Level.SEVERE, null, ex);
            }
            if (this.getReporteVentas()== null) {
                this.setReporteVentas(new ReporteVentas(ventasAMostrar));
